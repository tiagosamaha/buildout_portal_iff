...
#
# $LastChangedDate: 2010-03-06 09:04:51 -0800 (Sat, 06 Mar 2010) $ $LastChangedRevision: 33460M $
#
...
ZLIB_DIR=zlib-1.2.3
READLINE_TB=readline-5.2.tar.bz2
...
echo ""
echo "Installing Plone 3.3.5 at $PLONE_HOME"
echo ""
